...
public class CglibProxyCreator implements ProxyCreator {
	...
	private class HandledProxyInterceptor implements MethodInterceptor {
	...
	public Object createProxy(ClassLoader cl, Class<?>[] types,
		...
		// Finally, we use Objenesis to creat a new instance of the
		// class. The reason that we don't just use Class.newInstance()
		// is that the default Java reflection call to Class.newInstance()
		// will call the constructor of the super class of the dynamically
		// generated class. If our dynamically generated class inherits from
		// a class that does not have a default constructor, bad things happen.
		// Objenesis instantiates the object WITHOUT calling the constructor.
